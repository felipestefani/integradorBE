...
public class ConsultaService {
    ...
    public ResponseEntity salvar(ConsultaDTO consultaDTO){
        try {
            ...
            consulta.setChave(consultaDTO.getChave());
    ...
    public ResponseEntity deletarConsulta(ConsultaDTO consultaDTO){
        try{
            ...
            //Optional<Consulta> consulta = consultaRepository.findByIdPacienteAndIdDentistaAndDataConsulta(paciente.getId(), dentista.getId(), consultaDTO.getDataConsulta());
